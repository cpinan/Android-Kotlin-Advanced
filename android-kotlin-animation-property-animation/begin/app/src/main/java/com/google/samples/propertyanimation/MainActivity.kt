...
class MainActivity : AppCompatActivity() {
     ...
     * There are properties for position (called “translation”), rotation, scale, and transparency (called “alpha”).
     */
    /**
     * Now if you run the application again and click on ROTATE, you will see that the star does,
     * indeed, spin around its center. But it does so really quickly.
     * In fact, it does it in 300 milliseconds, which is the default duration of
     * all animations on the platform. 300 milliseconds is a decent default for most
     * animations, but in this case, we’d like more time to enjoy the animation.
     */
    private fun rotater() {
